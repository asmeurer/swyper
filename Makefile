...
# Code signing identity. Override with an Apple-issued certificate name
# (e.g. CODESIGN_IDENTITY="Developer ID Application: ...") to preserve
# Accessibility permissions across rebuilds. Defaults to ad-hoc signing.
CODESIGN_IDENTITY ?= -
...
bundle: build
	...
	@codesign --force --sign "$(CODESIGN_IDENTITY)" --entitlements Swyper.entitlements "$(APP_BUNDLE)/Contents/MacOS/Swyper"
